//sets variables that are used at this time.
let questionCount = 0;
...
//hides/reveals the worked solution on click
...
//hides/reveals the correct answer on click
...
//updates the display to show correct number of questions answered, the percentage of correct questions etc
//if user double clicks check your answer when answer is correct, will increase correct answer multiple times. No known fix at this time.
...
//checks user values against actual answers, increments a ounter if needs be. If reaches 10, answer is correct, fulfills IF requirements.
...
//generates random numbers for matrices and also to choose the questions
function randomNumberGenerator() {
  questionType = Math.floor(Math.random() * 21) + 1;

  rndmNum1 = Math.floor(((Math.random()) * 2 - 1) * 16); //creates random integer -16 to +15
  a1_1.value = rndmNum1;
  rndmNum2 = Math.floor(((Math.random()) * 2 - 1) * 16); //creates random integer -16 to +15
  a1_2.value = rndmNum2;
  rndmNum3 = Math.floor(((Math.random()) * 2 - 1) * 16); //creates random integer -16 to +15
  a2_1.value = rndmNum3;
  rndmNum4 = Math.floor(((Math.random()) * 2 - 1) * 16); //creates random integer -16 to +15
  a2_2.value = rndmNum4;
  rndmNum5 = Math.floor(((Math.random()) * 2 - 1) * 16); //creates random integer -16 to +15
  b1_1.value = rndmNum5;
  rndmNum6 = Math.floor(((Math.random()) * 2 - 1) * 16); //creates random integer -16 to +15
  b1_2.value = rndmNum6;
  rndmNum7 = Math.floor(((Math.random()) * 2 - 1) * 16); //creates random integer -16 to +15
  b2_1.value = rndmNum7;
  rndmNum8 = Math.floor(((Math.random()) * 2 - 1) * 16); //creates random integer -16 to +15
  b2_2.value = rndmNum8;


  rndmNum9 = Math.floor(((Math.random()) * 2 - 1) * 16); //creates random integer -16 to +15
  a1_3.value = rndmNum9;
  rndmNum10 = Math.floor(((Math.random()) * 2 - 1) * 16); //creates random integer -16 to +15
  a2_3.value = rndmNum10;
  rndmNum11 = Math.floor(((Math.random()) * 2 - 1) * 16); //creates random integer -16 to +15
  a3_1.value = rndmNum11;
  rndmNum12 = Math.floor(((Math.random()) * 2 - 1) * 16); //creates random integer -16 to +15
  a3_2.value = rndmNum12;
  rndmNum13 = Math.floor(((Math.random()) * 2 - 1) * 16); //creates random integer -16 to +15
  a3_3.value = rndmNum13;


  rndmNum14 = Math.floor(((Math.random()) * 2 - 1) * 16); //creates random integer -16 to +15
  b1_3.value = rndmNum14;
  rndmNum15 = Math.floor(((Math.random()) * 2 - 1) * 16); //creates random integer -16 to +15
  b2_3.value = rndmNum15;
  rndmNum16 = Math.floor(((Math.random()) * 2 - 1) * 16); //creates random integer -16 to +15
  b3_1.value = rndmNum16;
  rndmNum17 = Math.floor(((Math.random()) * 2 - 1) * 16); //creates random integer -16 to +15
  b3_2.value = rndmNum17;
  rndmNum18 = Math.floor(((Math.random()) * 2 - 1) * 16); //creates random integer -16 to +15
...
//the actual function. Clears all values, hides everything. Generates matrices and picks a // QUESTION
//Displays the question and sets the correct answers. Alters solution as required.
testStart.onclick = function() {
  ...
  if (questionType === 7) {
    matrix2x2Display();
    document.getElementById("theProblem").innerHTML = "Matrix A x Matrix B";
  ...
  if (questionType === 8) {
    matrix2x2Display();
    document.getElementById("theProblem").innerHTML = "Matrix B x Matrix A";
