...
randomB.onclick = function() { //function to create random matrix B.
  ...
  rndmNum1 = Math.round(((Math.random()) * 2 - 1) * 15.1); //creates random integer -16 to +15
  b1_1.value = rndmNum1;

  rndmNum2 = Math.round(((Math.random()) * 2 - 1) * 15.1); //creates random integer -16 to +15
  b1_2.value = rndmNum2;

  rndmNum3 = Math.round(((Math.random()) * 2 - 1) * 15.1); //creates random integer -16 to +15
  b2_1.value = rndmNum3;

  rndmNum4 = Math.round(((Math.random()) * 2 - 1) * 15.1); //creates random integer -16 to +15
  b2_2.value = rndmNum4;
...
inverseA.onclick = function() {
  ...
  if (determinantA2x2 === 0) {
    ...
    document.getElementById("ansMathJaxMatrix").innerHTML = "\\begin{bmatrix} " + ans1_1.value + " & " + ans1_2.value + "\\\\ " + ans2_1.value +
      " & " + ans2_2.value + "\\" + "end{bmatrix}";
    workedSolution.innerHTML = "The original matrix $A = \\begin{bmatrix} " + a1_1.value + " & " + a1_2.value + "\\\\ " + a2_1.value + " & " + a2_2.value + "\\end{bmatrix}$ <br><br>"

      +
      "<br>$A^{-1} = \\frac{1}{" + determinantA2x2 + "}$&ensp; x&ensp; $\\begin{bmatrix}" + a2_2.value + "& " + minusb + "\\\\" +
      minusc + "&" + a1_1.value + "\\end{bmatrix}$" + "<br><br><br> $A^{-1} = \\begin{bmatrix} " + ans1_1.value + " & " + ans1_2.value + "\\\\ " + ans2_1.value +
      " & " + ans2_2.value + "\\" + "end{bmatrix}$";
  }
...
inverseB.onclick = function() {
  ...
  if (determinantB2x2 === 0) {
    ...
    workedSolution.innerHTML = "The original matrix $B = \\begin{bmatrix} " + b1_1.value + " & " + b1_2.value + "\\\\ " +
      b2_1.value + " & " + b2_2.value + "\\end{bmatrix}$ <br><br>" +
      "<br>$B^{-1} = \\frac{1}{" + determinantB2x2 + "}$&ensp; x&ensp; $\\begin{bmatrix}" + b2_2.value + "& " + minusb + "\\\\" +
...
transposeA2x2.onclick = function() {
  ...
  workedSolution.innerHTML = "The original matrix $A = \\begin{bmatrix} " + a1_1.value + " & " + a1_2.value + "\\\\ " + a2_1.value +
    " & " + a2_2.value + "\\end{bmatrix}$ <br><br>" +
    "\\(A ^T\\) = $\\begin{bmatrix}" +
    ans1_1.value + "&" + ans1_2.value + "\\\\" + ans2_1.value + "& " + ans2_2.value + "\\end{bmatrix}$";
...
transposeB2x2.onclick = function() {
  ...
  workedSolution.innerHTML = "The original matrix $B = \\begin{bmatrix} " + b1_1.value + " & " + b1_2.value + "\\\\ " + b2_1.value +
    " & " + b2_2.value + "\\end{bmatrix}$ <br><br>" +
    "\\(B^T\\) = $\\begin{bmatrix}" +
    ans1_1.value + "&" + ans1_2.value + "\\\\" + ans2_1.value + "& " + ans2_2.value + "\\end{bmatrix}$";
...
determinantA2x2.onclick = function() {
  ...
  workedSolution.innerHTML = "The original matrix $A = \\begin{bmatrix} " + a1_1.value + " & " + a1_2.value + "\\\\ " +
    a2_1.value + " & " + a2_2.value + "\\end{bmatrix}$ <br><br>" +
    "$(" + a1_1.value +
...
determinantB2x2.onclick = function() {
  ...
  workedSolution.innerHTML = "The original matrix $B = \\begin{bmatrix} " + b1_1.value + " & " + b1_2.value + "\\\\ " + b2_1.value +
    " & " + b2_2.value + "\\end{bmatrix}$ <br><br>" +
    "$(" + b1_1.value + "$ x $ " + b2_2.value + ") - (" + b1_2.value + "$ x $" + b2_1.value + ") = " +
    determinantB2x2 + "$";
...
addition2x2.onclick = function() {
  ...
  workedSolution.innerHTML = "The original matrix $A = \\begin{bmatrix} " + a1_1.value + " & " + a1_2.value + " \\\\ " + a2_1.value + " & " + a2_2.value +
    "\\end{bmatrix}$ &ensp;&ensp;&ensp;The original matrix $B$ = $\\begin{bmatrix} " + b1_1.value + " & " + b1_2.value + "\\\\ " +
    b2_1.value + " & " + b2_2.value + "\\end{bmatrix}$ <br><br>" +
...
subtraction2x2AminusB.onclick = function() {
  ...
  workedSolution.innerHTML = "The original matrix $A = \\begin{bmatrix} " + a1_1.value + " & " + a1_2.value + " \\\\ " + a2_1.value + " & " + a2_2.value +
    "\\end{bmatrix}$ &ensp;&ensp;&ensp;The original matrix $B$ = $\\begin{bmatrix} " + b1_1.value + " & " + b1_2.value + "\\\\ " +
    b2_1.value + " & " + b2_2.value + "\\end{bmatrix}$ <br><br>" +
    "$\\begin{bmatrix} " + a1_1.value + " &nbsp;- &nbsp;" + b1_1.value + "&" + a1_2.value +
...
subtraction2x2BminusA.onclick = function() {
  ...
  workedSolution.innerHTML = "The original matrix $A = \\begin{bmatrix} " + a1_1.value + " & " + a1_2.value + " \\\\ " + a2_1.value + " & " + a2_2.value +
    "\\end{bmatrix}$ &ensp;&ensp;&ensp;The original matrix $B$ = $\\begin{bmatrix} " + b1_1.value + " & " + b1_2.value + "\\\\ " +
    b2_1.value + " & " + b2_2.value + "\\end{bmatrix}$ <br><br>" +
    "$\\begin{bmatrix} " + b1_1.value + " &nbsp;- &nbsp;" + a1_1.value + "&" + b1_2.value +
...
multiplyAB2x2.onclick = function() {
  ...
  workedSolution.innerHTML = "The original matrix $A = \\begin{bmatrix} " + a1_1.value + " & " + a1_2.value + " \\\\ " + a2_1.value + " & " + a2_2.value +
    "\\end{bmatrix}$ &ensp;&ensp;&ensp;The original matrix $B$ = $\\begin{bmatrix} " + b1_1.value + " & " + b1_2.value + "\\\\ " +
    b2_1.value + " & " + b2_2.value + "\\end{bmatrix}$" +
